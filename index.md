...
TimeEntry en ProGestor Se ampliará "ProGestor" para incluir:
...
La Solución: 
Comentarios en ProGestor Se ampliará "ProGestor" para incluir:
...
Adjuntos en ProGestor Se ampliará "ProGestor" para incluir:
...
Los usuarios necesitan una página de inicio que muestre de un vistazo la 
información más importante al entrar al sistema.
...
Dashboard Básico en ProGestor Se añadirá un dashboard sencillo que mostrará:
...
Sistema de Notificaciones con Eventos en ProGestor
...
1. TaskAssignedEvent y TaskAssignedNotificationListener
Evento
...
2. CommentCreatedEvent y CommentCreatedNotificationListener
Evento
...
3. TaskDueDateApproachingEvent y TaskDueDateNotificationListener
Evento
...
4. TaskStatusChangedEvent y TaskStatusChangedNotificationListener
Evento
...
5. UserMentionedEvent y UserMentionedNotificationListener
Evento
...
6. AttachmentUploadedEvent y AttachmentUploadedNotificationListener
Evento
...
7. ProjectStatusChangedEvent y ProjectStatusChangedNotificationListener
Evento
...
8. DayEndedEvent y TimeEntryReminderNotificationListener
Evento
